-- ============================================
-- Fix Institution Membership for jeremy.estrella@gmail.com
...
DECLARE
    ...
    v_input_auth_id UUID := NULL;
    v_input_email TEXT := 'jeremy.estrella@gmail.com';
...
BEGIN
    ...
    IF NOT v_profile_exists THEN
        ...
        INSERT INTO user_profiles (
            ...
            v_auth_user_id,
            v_user_email,
            'Jeremy Estrella', -- Using name from email
            NOW()
        );
