...
CREATE TABLE IF NOT EXISTS public.blueprint_goals (
  ...
  -- Format: [{department: string, challenges: string[], outcomes: string[], budget: number, timeline: string}]
  
  -- Student learning objectives
  learning_objectives jsonb DEFAULT '[]'::jsonb,
  -- Format: [{grade: string, subject: string, currentMetrics: {}, targetMetrics: {}}]
  ...
  training_capacity integer, -- hours per week
  
  -- Constraints
  timeline_preference text NOT NULL, -- '3months', '6months', '1year', '18months'
  budget_range text NOT NULL, -- 'under10k', '10k-50k', '50k-100k', '100k-250k', 'over250k'
...
CREATE TABLE IF NOT EXISTS public.blueprints (
  ...
  -- {dsch: {score: 0.75, factors: {}}, lei: {}, crf: {}, oci: {}, hoci: {}}
  maturity_level text,
  
  -- Implementation roadmap
  implementation_phases jsonb[] NOT NULL,
  -- [{phase: 1, title: string, duration: string, objectives: [], tasks: [], deliverables: [], budget: number}]
  
  -- Department-specific plans
  department_plans jsonb DEFAULT '[]'::jsonb,
  -- [{department: string, plan: {}, resources: [], timeline: {}}]
  ...
  department_pdfs jsonb DEFAULT '{}'::jsonb, -- {department: url}
...
CREATE TABLE IF NOT EXISTS public.blueprint_templates (
  ...
  variables jsonb DEFAULT '[]'::jsonb, -- [{key: string, description: string, defaultValue: any}]
...
CREATE TABLE IF NOT EXISTS public.recommendations_catalog (
  ...
  -- Resources
  related_tools text[],
  related_templates uuid[], -- References to blueprint_templates
