-- Safe User Profile System Migration
-- Handles existing tables gracefully with IF NOT EXISTS

-- Enable necessary extensions
CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

-- Create user_profiles table (safe creation)
...
-- Drop and recreate timestamp trigger
...
-- Create or replace view for user profile with institution data
