...
export default function HigherEdImplementationPage() {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-white">
          <div className="grid md:grid-cols-1 gap-8 items-center">
            <div className="text-center md:text-left">
              ...
              <ul className="mt-6 space-y-2 text-indigo-100 max-w-3xl">
                <li className="flex items-start justify-center md:justify-start"><CheckCircle className="h-5 w-5 text-emerald-300 mr-2 mt-0.5" /> Strategic roadmap, policies, training, and integration guidance generated by AI</li>
                <li className="flex items-start justify-center md:justify-start"><Shield className="h-5 w-5 text-emerald-300 mr-2 mt-0.5" /> FERPA-aligned deliverables and institutional data safeguards</li>
                <li className="flex items-start justify-center md:justify-start"><BookOpen className="h-5 w-5 text-emerald-300 mr-2 mt-0.5" /> Faculty development plans and curriculum integration playbooks</li>
              </ul>
              <div className="mt-6">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          {[
            ...
            <div key={p.name} className="bg-white border rounded-lg p-6 flex flex-col">
              ...
              <Button className="mt-auto w-full" onClick={() => { const el = document.getElementById('onboarding'); if (el) el.scrollIntoView({ behavior: 'smooth' }); }}>Start Now</Button>
            </div>
          ))}
        </div>
      </div>
  ...
  {/* Onboarding Form */}
  <div id="onboarding" className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Card>
          <CardHeader>
